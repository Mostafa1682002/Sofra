...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('regoins', function(Blueprint $table) {
	...
	public function down()
	{
		...
		Schema::table('regoins', function(Blueprint $table) {
			$table->dropForeign('regoins_city_id_foreign');
		});
		Schema::table('products', function(Blueprint $table) {
			$table->dropForeign('products_restaurant_id_foreign');
		});
		Schema::table('restaurants', function(Blueprint $table) {
			$table->dropForeign('restaurants_regoin_id_foreign');
		});
		Schema::table('category_restaurant', function(Blueprint $table) {
		...
		Schema::table('clients', function(Blueprint $table) {
			$table->dropForeign('clients_regoin_id_foreign');
		});
		Schema::table('reviews', function(Blueprint $table) {
